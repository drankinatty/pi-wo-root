...
int main (int argc, char **argv) {
  ...
  printf ("  Outputting %d analog input samples at 5Hz  (~%d sec)\n\n"
          "  channel, reg-values and voltages:\033[?25l\n\n",
          samples, samples / 5);
...
100 analog input samples, results and voltages:

  channel[0] : 0x675b  (3.31 V)
  channel[1] : 0x3a7e  (1.87 V)
  channel[2] : 0x3131  (1.57 V)
  channel[3] : 0xffff  (0.00 V)
