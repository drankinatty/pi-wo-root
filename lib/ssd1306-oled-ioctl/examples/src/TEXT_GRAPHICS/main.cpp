...
bool SetupTest()
{
	...
	*/
	...
	puts ("Running as root -- no longer required!");

	printf("SSD1306 library Version Number :: %u\r\n",myOLED.getLibVerNum());
	// printf("bcm2835 library Version Number :: %u\r\n",bcm2835_version());
	usleep (500000);
	// myOLED.OLEDbegin(I2C_devfd, I2C_Address, I2C_debug); // initialize the OLED

	/* default values are fine for devfd, addr, debug */
	myOLED.OLEDinit();
